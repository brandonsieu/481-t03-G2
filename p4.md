...
## Introduction
This report covers Kaynyne's design process from start to present. Inside you will find the design team's thought processes and work accomplished towards designing an app where we are not the users: the design problem/prompt and its context, our user research and its findings, our brainstormed design, a heuristic evaluation on our latest prototype, and lastly how we can move forward in improving the design.

Included is an executive summary, and aftewards the entire report.
...
#### Conclusion
Kaynyne's design process went through several changes and shifts in priority. These were based on our user research and prototyping deadlines. Our evaluations of Kaynyne's current design provide a strong basis for improvement and further development. Kaynyne's entire design process was highly informative with the mistakes a designer can make.
